...
class ProgressElement(ContainerElement):
    def __init__(self, parameter, parent = None, name = None):
        ...
        super(ProgressElement, self).__init__(parameters = None, parameter = parameter, parent = parent, name = name)
    ...
    def createChildForParameter(self, parameter):
        ...
        if parameterId == 3:
            from watchFaceParser.models.gts2mini.elements.goalProgress.circularGoalProgressElement import CircularGoalProgressElement
            self._circular = CircularGoalProgressElement(parameter = parameter, parent = self, name = 'Circular')
            return self._circular
        elif parameterId == 1:
            from watchFaceParser.models.gts2mini.elements.goalProgress.stepGaugeElement import StepGaugeElement # temp.
            self._images1 = StepGaugeElement(parameter = parameter, parent = self, name = '?_images?')
            return self._images1
        elif parameterId == 2:
            from watchFaceParser.models.gts2mini.elements.goalProgress.stepsLinearElement import StepsLinearElement
            ...
            return super(ProgressElement, self).createChildForParameter(parameter)
