...
class PulseLinearElement(IconSetElement):
    ...
    def __init__(self, parameter, parent, name = None):
        self._ar = []
        #self._slices = 0
        super(PulseLinearElement, self).__init__(parameter = parameter, parent = parent, name = name)
    ...
    def draw3(self, drawer, resources, state):
        ...
        #if 
        super(PulseLinearElement, self).draw3(drawer, resources, int(state.getPulse() * len(self._ar) / 150))
