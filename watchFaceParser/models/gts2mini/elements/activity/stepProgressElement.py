...
class StepProgressElement(ContainerElement):
    ...
    def draw3(self, drawer, resources, state):
        ...
        if self._circle_scale:
            self._circle_scale.draw4(drawer, resources, state.getSteps(), state.getGoal())
        if self._scale:
            self._scale.draw4(drawer, resources, state.getSteps(), state.getGoal())
    ...
    def createChildForParameter(self, parameter):
        ...
        elif parameterId == 4: # CircleScale
