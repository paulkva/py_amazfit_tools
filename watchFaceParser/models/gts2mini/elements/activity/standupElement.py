...
class StandUpElement(CompositeElement):
    def __init__(self, parameter, parent, name = None):
        self._image_number = None
        self._nodata = None
        self._icon = None
        super(StandUpElement, self).__init__(parameters = None, parameter = parameter, parent = parent, name = name)
    ...
    def createChildForParameter(self, parameter):
        ...
        if parameterId == 1:
            ...
            super(StandUpElement, self).createChildForParameter(parameter)
